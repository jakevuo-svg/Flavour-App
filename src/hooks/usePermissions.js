...
const DEFAULT_PERMISSIONS = {
  admin: {
    tab_persons: true, tab_date: true, tab_events: true, tab_archive: true, tab_locations: true, tab_notes: true, tab_admin: true,
  ...
  worker: {
    tab_persons: false, tab_date: true, tab_events: true, tab_archive: true, tab_locations: true, tab_notes: true, tab_admin: false,
  ...
  temporary: {
    tab_persons: false, tab_date: true, tab_events: true, tab_archive: false, tab_locations: false, tab_notes: true, tab_admin: false,
